...
- Upstream issue draft (this fork): `work/2026-05-09/02-upstream-issue-draft-fsm-gap-news-intent.md` — frames the FSM gap for `mvanhorn/last30days-skill` (now updated 2026-05-10 to include the third and fourth silent-failure paths)
...
- Source: `skills/last30days/scripts/lib/planner.py` — four warning sites total (three in `_sanitize_plan`, one in `_trim_subqueries_for_depth`)
